<%@ Page Title="portfolio-single-video" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="portfolio-single-video.aspx.cs" Inherits="portfolio_single_video" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="portfolio-single-video">
        <!--breadcrumbs start-->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 ">
                    ...
                    <p>
                        <button class="btn bg-maroon margin"><i class="fa fa-external-link pr-5"></i>Preview</button></p>
                </div>
