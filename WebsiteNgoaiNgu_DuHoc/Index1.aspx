<%@ Page Title="Index1" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Index1.aspx.cs" Inherits="Index1" %>
        ...
        <div id="sequence-theme">
            <div id="sequence">
                ...
                <ul class="sequence-canvas">
                    <li class="animate-in">
                        <div class="intro">
                            <h2>Built using Sequence.js
                            </h2>
                            <h3>The Responsive Slider with Advanced CSS3 Transitions
                            </h3>
                        </div>
