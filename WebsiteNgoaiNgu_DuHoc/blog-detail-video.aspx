<%@ Page Title="Blog Detail Video" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="blog-detail-video.aspx.cs" Inherits="blog_detail_video" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="Blog-Detail-Video">
        <!--breadcrumbs start-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="active">Blog Detail video
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-sm-10">
                                ...
                                <div class="video-container">
                                    <iframe width="500" height="281" src="https://www.youtube.com/embed/qvBX9VgPGSg" allowfullscreen="" style="border: none;"></iframe>
                                </div>
                  ...
                  <a href="#">Admin
                                ...
                                <div class="st-view">
                                    <ul class="list-unstyled">
                                        <li>
                                            ...
                                            <a href="javascript:;">209 View
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:;">23 Share
                                            </a>
                                        </li>
                            ...
                            <div class="col-lg-10 col-sm-10">
                                <h1>
                                    <a href="blog_detail.html">Suspendisse dignissim in sem eget pulvinar. Mauris aliquam nulla at libero pretium.
                                    </a>
                                </h1>
                                <p>
                    ...
                    <cite title="Source Title">Source Title
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">Maria Marque
                      <span>|
                      </span>
                                            <span>12 July 2014, 10:20
                                            </span>
                                        </h4>
                                        <p>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h4 class="media-heading">Allie Doe
                          <span>|
                          </span>
                                                    <span>12 July 2014, 10:30
                                                    </span>
                                                </h4>
                                                <p>
                                                    Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui.
